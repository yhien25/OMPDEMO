			...
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#">
						<img src="../../assets/images/LOGO.png" height = "40px" width="150px" class="logo">
					</a>
				</div>
						...
						<li class="dropdown ">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<!--<li class=""><a href="#">Change Password</a></li>							<li class=""><a href="#">Add Account</a></li>
									<li class="divider"></li>-->
					...
					<!-- Main Menu -->
							<div class="side-menu-container" >
								<ul class="nav navbar-default">
									<li><a href="?tran=Category"><span class="glyphicon glyphicon-th"></span> Category</a></li>
									<li><a href="?tran=Product"><span class="glyphicon glyphicon-tags"></span> Posted Product</a></li>
									<li><a href="?tran=Admin"><span class="glyphicon glyphicon-user"></span>Admin Account</a></li>
